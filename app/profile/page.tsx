          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { image: '/BuiDuongTin-2280603198-Blog/images/nw.png', title: 'Thành tựu 1', pdfLink: '/BuiDuongTin-2280603198-Blog/images/NetworkingBasicsUpdate20251026-30-vihrkg.pdf' },
                  ...
                  { image: '/BuiDuongTin-2280603198-Blog/images/jv1.png', title: 'Thành tựu 3', pdfLink: '/BuiDuongTin-2280603198-Blog/images/JavaScriptEssentials1Update20251026-32-f18m22.pdf' }
                ].map((achievement) => (
                  <div
