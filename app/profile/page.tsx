            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700 sticky top-24">
              ...
              <div className="flex justify-center mb-6">
                <div className="relative animate-float">
                  ...
                  <div className="relative w-48 h-48 rounded-full flex items-center justify-center text-6xl font-extrabold shadow-2xl border-4 border-transparent bg-clip-padding bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-600">
                    BĐT
                  </div>
                </div>
              </div>
